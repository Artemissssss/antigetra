...
bot.on("text", async msg => {
    ...
    if(username!=="Artemis_Vainshtein" && username !=="vladda_ak" && username !=="Mirabell_uww" && username !=="fkyib" && username !=="theycallmenazar" && username !=="mzahruy" && username !=="meowvvviks" && username !== "Ciacam"){
        if(text1.indexOf("ге")<text1.indexOf("те") && text1.indexOf("те")-text1.indexOf("ге") < 10){
            banStatus = true;
        }else if(text1.indexOf("г")<text1.indexOf("ете") && text1.indexOf("ете")-text1.indexOf("г") < 10){
            banStatus = true;
        }
        else if(text1.indexOf("гет")<text1.indexOf("е") && text1.indexOf("к")-text1.indexOf("гет") < 10){
            banStatus = true;
        }
